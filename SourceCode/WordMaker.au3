...
Global $letter, $FirstLetter, $Word_Input, $Title, $ObjectPath, $symb, $NsLetRead, $dLetRead, $ReadKa1Let, $ReadKa2Let, $ReadKa3Let, $ReadKd1Let, $ReadKd2Let, $ReadKd3Let, $ReadKs1Let, $ReadKs2Let
Global	$ReadKs3Let, $ReadKe1Let, $ReadKe2Let, $ReadKe3Let, $ReadScaleLet, $NsSymRead, $dSymRead, $ReadKa1Sym, $ReadKa2Sym, $ReadKa3Sym, $ReadKd1Sym, $ReadKd2Sym, $ReadKd3Sym, $ReadKs1Sym
...
Global $NsWingRead, $dWingRead, $ReadKa1Wing, $ReadKa2Wing, $ReadKa3Wing, $ReadKd1Wing, $ReadKd2Wing, $ReadKd3Wing, $ReadKs1Wing, $ReadKs2Wing, $ReadKs3Wing, $ReadKe1Wing, $ReadKe2Wing, $ReadKe3Wing, $ReadScaleWing, $ReadIllumWing
...
Global $Version = "4.0", $Xcoor = $XShift, $Ycoor = 0, $lineNumber = 0, $FontType = "Letter"
...
Global $WordMakerGUI = GUICreate("WordMaker", 960, 650, -1, -1, BitOR($WS_MINIMIZEBOX, $WS_CAPTION, $WS_SYSMENU, $WS_EX_CLIENTEDGE))
...
Global $ClearRoom_Button = GUICtrlCreateButton("Clear Room", 860, 35, 65, 30)
...
#ce
	...
	Global $Clear_Button = GUICtrlCreateButton("Clear Text", 670, 35, 60, 30)
	GUICtrlSetOnEvent($Clear_Button, "_Clear_Edit")
	GuiCtrlSetTip($Clear_Button, "Clears the text field")

	Global $WriteWord_Button = GUICtrlCreateButton("Write to Words Room", 670, 85, 60, 50, $BS_MULTILINE)
	GUICtrlSetOnEvent($WriteWord_Button, "_Write_WordRoom")
	GuiCtrlSetTip($WriteWord_Button, "Writes your text to the Words.room file")

	Global $WriteSession_Button = GUICtrlCreateButton("Write to Session Room", 750, 85, 60, 50, $BS_MULTILINE)
	...
	$Letters = GUICtrlCreateGroup("Restart VRToolbox to see changes to these fields:", 5, 145, 950, 490, $BS_CENTER)
	GUICtrlSetFont(-1, 14, 400, 4, "MS Sans Serif")
	$Letters = GUICtrlCreateGroup("Letters", 15, 180, 295, 430)
	GUICtrlSetFont(-1, 16, 400, "MS Sans Serif")
	$Symbols = GUICtrlCreateGroup("Symbols", 330, 180, 295, 430)
	GUICtrlSetFont(-1, 16, 400, "MS Sans Serif")
	$WingDings = GUICtrlCreateGroup("WingDings", 645, 180, 295, 360)
	GUICtrlSetFont(-1, 16, 400, "MS Sans Serif")

	$CopyWingFiles = GUICtrlCreateButton("Write WingDings", 835, 195, 100, 20)
	...
	$Scale = GUICtrlCreateLabel("Scale", 40, 500, 49, 24)
	GUICtrlSetFont(-1, 12, 600, 0, "MS Sans Serif")
	...
	GUICtrlSetFont(-1, 12, 600, 0, "MS Sans Serif")
	$Label5 = GUICtrlCreateLabel("Scale", 356, 500, 49, 20)
	GUICtrlSetFont(-1, 12, 600, 0, "MS Sans Serif")
	...
	GUICtrlSetFont(-1, 12, 600, 0, "MS Sans Serif")
	$ScaleWing = GUICtrlCreateLabel("Scale", 670, 500, 49, 24)
	GUICtrlSetFont(-1, 12, 600, 0, "MS Sans Serif")
	...
	GUICtrlSetColor(-1, 0xFF0000)
	$ReadScaleLet = GUICtrlCreateInput("Scale", 100, 500, 40, 20)
	GUICtrlSetColor(-1, 0xFF0000)
	...
	GUICtrlSetColor(-1, 0xFF0000)
	$ReadScaleSym = GUICtrlCreateInput("Scale", 415, 500, 40, 20)
	GUICtrlSetColor(-1, 0xFF0000)
	...
	GUICtrlSetColor(-1, 0xFF0000)
	$ReadScaleWing = GUICtrlCreateInput("Scale", 730, 500, 40, 20)
	GUICtrlSetColor(-1, 0xFF0000)

	$WriteLet = GUICtrlCreateButton("Write", 172, 465, 113, 57)
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x008000)
	...
	$WriteSym = GUICtrlCreateButton("Write", 487, 465, 113, 57)
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x008000)
	...
	$WriteWing = GUICtrlCreateButton("Write", 802, 465, 113, 57)
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x008000)
	...
	$ChangeLetterFont = GUICtrlCreateButton("Change Font",40, 540, 113, 57)
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x008000)
	GUICtrlSetOnEvent($ChangeLetterFont, "_Change_LetterFonts")

	$LabelLetterFont = GUICtrlCreateLabel("Current Font", 170, 550, 100, 24)
	GUICtrlSetFont(-1, 10, 600, 4, "MS Sans Serif")
	Global $CurrentFont = GUICtrlCreateLabel($FontStateLetter, 175, 570, 100, 24)
	GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")

	$ChangeSymbolFont = GUICtrlCreateButton("Change Font", 356, 540, 113, 57)
	GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
	GUICtrlSetColor(-1, 0xFFFFFF)
	GUICtrlSetBkColor(-1, 0x008000)
	GUICtrlSetOnEvent($ChangeSymbolFont, "_Change_SymbolFonts")

	$LabelSymbolFont = GUICtrlCreateLabel("Current Font", 485, 550, 100, 24)
	GUICtrlSetFont(-1, 10, 600, 4, "MS Sans Serif")
	Global $CurrentSymbolFont = GUICtrlCreateLabel($FontStateSymbol, 490, 570, 100, 24)
	GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")

	Global $Exit_Button = GUICtrlCreateButton("Exit", 900, 590, 50, 40)
