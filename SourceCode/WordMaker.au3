...
Global	$ReadKs2Sym, $ReadKs3Sym, $ReadKe1Sym, $ReadKe2Sym, $ReadKe3Sym, $ReadScaleSym, $ReadIllumLet, $ReadIllumSym, $Room, $Copying, $CurrentFont
...
Global $Version = "1.2", $Xcoor = $XShift, $Ycoor = 0, $lineNumber = 0, $FontType = "Letter"
